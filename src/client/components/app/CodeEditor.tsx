 ...
 *
 * The one change from the copy under `legacy/`: the handle comes through
 * `forwardRef` rather than a `ref` prop, because a ref in the props object is
 * a React 19 affordance and this app is on 18.2.
 */
export const CodeEditor = forwardRef<CodeEditorHandle, Props>(function CodeEditor(
  { id, value, onChange, label, className },
  ref,
) {
